    ...
    <main>
      ...
      >
        {listing.imgUrls.map((url, index) => (
          <SwiperSlide style={{ background: "cover" }} key={index}>
            <div
      ...
      {shareLinkCopied && (
        ...
        font-semibold border-2 border-gray-400 
      ...
      <div
        className="flex flex-col md:flex-row max-w-6xl 
      ...
      >
        <div className=" w-full   ">
          ...
          >
            ...
            <p
              className="w-full max-w-[200px] bg-green-800 rounded-md
            p-1 text-white text-center font-semibold shadow-md
            "
            >
              {listing.offer && (
                <p>
          ...
          <ul className="flex items-center space-x-2 lg:space-x-10 text-sm font-semibold mb-6 ">
            ...
            <li className="flex items-center whitespace-nowrap  ">
              ...
              {+listing.bathrooms > 1 ? `${listing.bathrooms} Beds ` : "1 Bath"}
            </li>
            <li className="flex items-center whitespace-nowrap  ">
          ...
          hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700
            focus:shadow-lg w-full text-center transition duration-150
            ease-in-out
          "
              >
                Contact Landlord
